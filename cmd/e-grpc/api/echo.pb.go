...
func (x *RequestEcho) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *ReplyEcho) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ReplyEcho) ProtoMessage() {}

func (x *ReplyEcho) ProtoReflect() protoreflect.Message {
	mi := &file_echo_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ReplyEcho.ProtoReflect.Descriptor instead.
func (*ReplyEcho) Descriptor() ([]byte, []int) {
	return file_echo_proto_rawDescGZIP(), []int{1}
}

func (x *ReplyEcho) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
var file_echo_proto_rawDesc = []byte{
	...
	,
...
var file_echo_proto_goTypes = []interface{}{
	(*RequestEcho)(nil), // 0: api.RequestEcho
	(*ReplyEcho)(nil),   // 1: api.ReplyEcho
}
var file_echo_proto_depIdxs = []int32{
	0, // 0: api.Echo.Say:input_type -> api.RequestEcho
	1, // 1: api.Echo.Say:output_type -> api.ReplyEcho
